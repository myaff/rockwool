...
--><style type="text/css">
	.svg-check-dims { width: 30px; height: 24.67px; }
...
--><svg width="0" height="0" style="position:absolute"><symbol viewBox="0 0 317.068 260.74" id="check" xmlns="http://www.w3.org/2000/svg"><path d="M315.714.028c-88.576 19.054-164.725 73.029-212.611 147.333A236.611 236.611 0 0 0 6.79 110.78c-2.182-.316-4.43.285-6.104 1.72-.701.602-1.036 1.144-.163 1.873 67.612 56.506 93.802 125.955 100.014 145.05.55 1.691 2.893 1.772 3.579.132 11.537-27.569 24.785-53.817 39.543-78.536 45.387-76.082 104.988-137.732 172.87-178.956 1.073-.65.41-2.299-.815-2.035"/></symbol><symbol viewBox="0 0 500 500" id="cross" xmlns="http://www.w3.org/2000/svg"><path d="M250 143.565L106.436.001 0 106.435 143.564 250 0 393.563 106.436 500 250 356.437 393.564 500 500 393.563 356.437 250 500 106.435 393.564.001z"/></symbol></svg><!--
====================================================================================================
...
--><h3>A) Inline SVG with embedded sprite</h3><ul><li title="check"><div class="icon-box"><!-- check --><svg class="svg-check-dims"><use xlink:href="#check"></use></svg></div><h2>check</h2></li><li title="cross"><div class="icon-box"><!-- cross --><svg class="svg-cross-dims"><use xlink:href="#cross"></use></svg></div><h2>cross</h2></li></ul><!--
====================================================================================================
--></section><section><!--
...
--><h3>B) Inline SVG with external sprite (IE 9-11 with polyfill only)</h3><ul><li title="check"><div class="icon-box"><!-- check --><svg class="svg-check-dims"><use xlink:href="sprite.svg#check"></use></svg></div><h2>check</h2></li><li title="cross"><div class="icon-box"><!-- cross --><svg class="svg-cross-dims"><use xlink:href="sprite.svg#cross"></use></svg></div><h2>cross</h2></li></ul><!--
====================================================================================================
--></section><footer><p>Generated at Thu, 19 Apr 2018 11:33:40 GMT by <a href="https://github.com/jkphl/svg-sprite" target="_blank">svg-sprite</a>.</p></footer></body></html>';