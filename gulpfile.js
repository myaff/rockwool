...
gulp.task('webpack', function(callback){
    ...
    let options = {
        ...
        output: {
            ...
            publicPath: (isDevelopment ? '/nioxin/build/js/' : '/html/build/js/'),
            libraryTarget: 'var',
            library: "Main",
            filename: "[name].js"
        },
...
gulp.task('build', gulp.parallel('css:build', 'assets:build', 'data:build', 'svg:build', 'js:build', 'image:build', 'webpack', 'pug'));
